...
- Divide and Conquer, 문제를 잘개 쪼개어 해결하는 분할 정복 개념이 적용된 대표적 알고리즘이다. 
- 병합정렬은 최선, 최악의 모든 경우에도 O(nlogn)의 시간 복잡도를 갖기 때문에 데이터 분포의 영향을 덜 받는다. 즉 어떤 경우에도 좋은 성능을 보장받을 수 있다.
- 별도의 메모리 공간이 필요하여 정렬할 데이터의 양이 많을 경우 그만큼 이동 횟수가 많아져 시간적인 낭비도 많아지게 된다. 
...
<img width="794" alt="스크린샷 2022-10-19 오후 9 30 03" src="https://user-images.githubusercontent.com/69416561/196695654-b055e866-28e2-4b33-881e-1249ad525bb9.png">
